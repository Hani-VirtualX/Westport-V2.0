...
void UAzr_Teleport::UpdateArc()
{
	...
	// FIX 1: Set SimFrequency to match Mesh Pool size (15Hz * 2.0s = 30 points)
...
void UAzr_Teleport::PerformTeleport()
{
	...
	// FIX 2: Clear existing timer to prevent spam/overlap
	...
	// FIX 3: Removed [this] capture. Captured Duration by Value.
